<?php
    ...
    if(isset($_POST['signup']))
    {
        ...
        $addUser = "INSERT INTO users(f_name, s_name, username, email, role, address, password) VALUES('$fname','$lname','$uname','$email','$role','$location','$password')"; 
        ...
        else
        {
            ...
            {
                $getUser = "SELECT * FROM users WHERE (username ='$uname' OR email = '$uname') AND (password = '$password' AND role = '$role')";
